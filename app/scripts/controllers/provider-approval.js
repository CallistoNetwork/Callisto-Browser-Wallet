...
class ProviderApprovalController {
  ...
  /**
   * Called by a tab to determine if CallistoHub is currently locked or unlocked
   */
  ...
  /**
   * Tells all tabs that CallistoHub is now locked. This is primarily used to set
