...
export default class QrScanner extends Component {
  ...
  parseContent (content) {
    ...
    // For ex. EIP-681 (https://eips.Callisto Network.org/EIPS/eip-681)


    // Callisto Network address links - fox ex. Callisto Network:0x.....1111
    if (content.split('ethereum:').length > 1) {

      type = 'address'
      values = {'address': content.split('ethereum:')[1] }

    // Regular Callisto Network addresses - fox ex. 0x.....1111
